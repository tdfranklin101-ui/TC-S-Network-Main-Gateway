...
const CATEGORY_MAP = {
  ...
  'Audio & Music': { category: 'Music', subcategory: 'Audio & Music' },
  ...
  'Videos': { category: 'Video', subcategory: null },
  ...
  'Music & Sound Effects': { category: 'Music', subcategory: 'Music & Sound Effects' },
  ...
  'Music & Audio': { category: 'Music', subcategory: 'Music & Audio' },
  ...
  'Audio': { category: 'Music', subcategory: 'Audio' },
  ...
  'Audio & Sound Design': { category: 'Music', subcategory: 'Audio & Sound Design' },
  ...
  'Audio/ Music': { category: 'Music', subcategory: null },
  'Shelter Management Tools': { category: 'Basic Needs', subcategory: 'Shelter Management' },
  'Music & Sound Healing': { category: 'Music', subcategory: 'Music & Sound Healing' },
  ...
  'Audio Tools': { category: 'Music', subcategory: 'Audio Tools' },
  ...
  'Stock Footage': { category: 'Video', subcategory: 'Stock Footage' },
  ...
  'Audio Assets': { category: 'Music', subcategory: 'Audio Assets' },
  ...
  'Media & Entertainment': { category: 'Video', subcategory: 'Media & Entertainment' },
  ...
  'real estate': { category: 'Rent', subcategory: 'Real Estate' },
  'Audio Loops': { category: 'Music', subcategory: 'Audio Loops' },
