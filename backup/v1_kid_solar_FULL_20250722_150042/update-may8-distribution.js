/**
 * The Current-See May 8, 2025 Distribution Update
 * 
 * This script updates member SOLAR totals to match what they should be as of May 8, 2025
 */
...
async function processMay8Distribution() {
  log(`=== The Current-See May 8, 2025 Distribution Update ===`, colors.blue);
  ...
  log(`=== May 8, 2025 distribution update completed successfully ===`, colors.green);
  return true;
}

// Run the distribution
processMay8Distribution().then(success => {
  if (success) {
    log('May 8, 2025 SOLAR distribution has been processed successfully!', colors.green);
    ...
    log('Failed to process May 8, 2025 distribution', colors.red);
    process.exit(1);
  }
});