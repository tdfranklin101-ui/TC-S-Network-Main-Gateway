// Node 18+
// Usage: node SolarStandard/generators/solar-index.js --id=<id> --type=<type> --kwh=123 --name="Artifact Name" --verification=REC --source=SOLAR --geo=US-CA
import fs from "fs";
...
const jsonld = {
  ...
  "@type": "Product", // generic; fine for artifacts/models; can refine per type
  "name": name,
  "identifier": id,
  "category": type,
...
// 2) Append/update SolarFeed.xml with a new entry
